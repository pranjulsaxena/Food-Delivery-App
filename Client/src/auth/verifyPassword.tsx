import React, { use, type ChangeEvent, type KeyboardEvent, type KeyboardEventHandler } from "react";
...
function VerifyPassword() {
  ...
  const handleBackspage = (key:string,index:number) => {
