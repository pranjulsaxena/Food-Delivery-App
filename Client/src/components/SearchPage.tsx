    ...
    <div className="max-w-10xl mx-auto px-4 md:px-8 flex flex-col md:flex-row gap-5 my-10">
      ...
      <div className="flex-1 flex flex-col">
        <div className="w-full flex gap-2 px-1">
          ...
          ></Input>
          <Button className="bg-[#D19254] text-white" onClick={() => {
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3 ">
            <div className="">
              <h2 className="font-bold">
                {searchedrestaurant.length} Search results found
              </h2>
              <div>
                {filteredCuisines.map(
                  (selectedFilter, idx) => (
                    <div key={idx} className="inline-flex mr-2 relative">
                      <Badge
                        ...
                        variant="outline" onClick={()=>{setfilteredCuisines(filteredCuisines.filter((cuisines)=>cuisines!==selectedFilter))}}
                      >
              ...
              >
                ...
                <CardContent className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center  text-gray-600 text-sm">
                    ...
                    City:{" "}
                    <span className="font-bold mx-1">{restaurant.city}</span>
                  </div>
...
// If you pass searchTerm as a prop
  ...
  return (
    <div className="text-center">
      ...
      <p className="mt-2 text-gray-500">
        We couldn't find any results for "{searchTerm}". Try searching with a
        different term.
      </p>
      <Link to="/">
